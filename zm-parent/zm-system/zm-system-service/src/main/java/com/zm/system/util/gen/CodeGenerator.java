package com.zm.system.util.gen;
...
public class CodeGenerator {
    ...
    // 全包名
    static final String packageName = "com.zm.zmdb";
    // 数据库url
    ...
    // 开启swagger
    static final boolean isSwagger = false;
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/zm-parent/zm-db/src/main/java");
        gc.setAuthor(author);
        gc.setOpen(false);
        ...
        templateConfig.setEntity("/ftl/gen/entity.java");
        templateConfig.setService("/ftl/gen/service.java");
        templateConfig.setServiceImpl("/ftl/gen/serviceImpl.java");
        templateConfig.setController("/ftl/gen/controller.java");
        templateConfig.setMapper("/ftl/gen/mapper.java");
        ...
        strategy.setSuperEntityClass(packageName + ".entity.bo.AbstractEntityModel");
